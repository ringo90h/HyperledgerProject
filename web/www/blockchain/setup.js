...
const { config, DEFAULT_CONTRACT_TYPES } = require('./config');
const { OrganizationClient } = require('./utils');
console.debug(OrganizationClient)
...
module.exports.subscribeStatus = (cb) => {
...
(async () => {
  ...
  try {
    await getAdminOrgs();
    console.log('checking ChannelMembership')
  ...
  // try {
  //   console.log('getting installation status of the chaincode');
...
module.exports.repairShopClient = repairShopClient
module.exports.policeClient = policeClient
